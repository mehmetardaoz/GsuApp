...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    Button register,forgot,login,cancel,cont_code,cancel1;
    Button cont;
    String emailtxt,passwordtxt,email_res_txt;
    EditText res_email,code,newpass;
    ServerRequest sr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  pref = getSharedPreferences("AppPref",MODE_PRIVATE);
        ...
        login.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                emailtxt = mEmailView.getText().toString();
                passwordtxt = mPasswordView.getText().toString();
                params = new ArrayList<NameValuePair>();
                params.add(new BasicNameValuePair("email", emailtxt));
                params.add(new BasicNameValuePair("password", passwordtxt));
                ServerRequest sr = new ServerRequest();
                JSONObject json = sr.getJSON("http://deneme-gleoozhk.c9.io:8080/login",params);
                if(json != null){
                    try{
                        String jsonstr = json.getString("response");
                        if(json.getBoolean("res")){
                            token = json.getString("token");
                            grav = json.getString("grav");
                         //   SharedPreferences.Editor edit = pref.edit();
                            //Storing Data using SharedPreferences
                            session.createUserLoginSession(token,grav);
                            ...
                            //TODO: Profile Activity Yapılacak
                            Intent profactivity = new Intent(LoginActivity.this,ProfileActiv.class);
        ...
        forgot.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cont = (Button) reset.findViewById(R.id.resetbtn);
                ...
                res_email = (EditText) reset.findViewById(R.id.forgotemail);
                cont.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // JSONObject json = sr.getJSON("http://nodemail-nodemail.rhcloud.com/resetpass", params);
                        JSONObject json = sr.getJSON("http://deneme-gleoozhk.c9.io:8080/login",params);
                        if (json != null) {
                            try {
                                String jsonstr = json.getString("response");
                                if(json.getBoolean("res")){
                                    ...
                                    reset.setContentView(R.layout.reset_pass_code);
                                     cont_code = (Button) reset.findViewById(R.id.cont2);
                                     code = (EditText) reset.findViewById(R.id.code);
                                     newpass = (EditText) reset.findViewById(R.id.newpass);
                                     cancel1 = (Button) reset.findViewById(R.id.cancel2);
